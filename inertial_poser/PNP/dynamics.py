...
from inertial_poser.PNP.utils import *
from qpsolvers import solve_qp


class PhysicsOptimizer:
    physics_model_file = 'inertial_poser/PNP/physics.urdf'  # physics body model path
    physics_parameter_file = 'inertial_poser/PNP/physics_parameters.json'  # physics hyperparameters
